                    ...
                    <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle me-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars color-3"></i></button>
                        ...
                        <ul class="navbar-nav flex-nowrap ms-auto">
                            ...
                            if (isset($_SESSION['id_user'])) {
                                $img = (isset($_SESSION['icon_user'])) ? ($_SESSION['icon_user']) : ("assets/img/avatars/avatar1.jpeg");
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <div class="nav-item dropdown no-arrow"><a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#"><span class="d-none d-lg-inline me-2 text-gray-600 small"><?php echo ($_SESSION['name_user']); ?> (<?php echo ($_SESSION['type_user']);?>)</span><img class="border rounded-circle img-profile" src="<?php echo ($project_data['icon_user']); ?>"></a>
